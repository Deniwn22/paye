...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/subscriptions.CreatePlanRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/reports/statements/verify/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Verification Ref (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/virtual-accounts/misdirected/{id}/resolve": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Misdirected Payment ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "dto.UpdateVADTO": {
            ...
            "properties": {
                "account_name": {
                    "type": "string",
                    "example": "Thompson Oretan Updated"
                }
            }
        },
        ...
        "subscriptions.CreatePlanRequest": {
            "type": "object",
            "required": [
                "amount",
                "currency",
