...
ALTER TABLE payment_providers ADD COLUMN IF NOT EXISTS test_credentials TEXT;
ALTER TABLE payment_providers ADD COLUMN IF NOT EXISTS notes TEXT;
...
ALTER TABLE payment_providers DROP COLUMN IF EXISTS test_credentials;
ALTER TABLE payment_providers DROP COLUMN IF EXISTS notes;
